...
import { Warning } from '@site/src/components/Callouts';
...
<Card title="OAuth Benefits" icon="shield-check" color="#22c55e">
...
<Accordion title="Complete Google Workspace Setup">
...
<Accordion title="Complete Azure Setup">
...
<Accordion title="Complete Okta Setup">
...
<Accordion title="Complete OneLogin Setup">
