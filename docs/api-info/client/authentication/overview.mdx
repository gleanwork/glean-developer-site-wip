...
<CardGroup cols={2}>
  <Card title="OAuth (Recommended)" icon="shield-check" color="#22c55e">
  ...
  <Card title="Glean Tokens (Alternative)" icon="key" color="#3b82f6">
...
<CardGroup cols={2}>
  <Card title="OAuth Authentication" href="./oauth" icon="shield-check" color="#22c55e">
  ...
  <Card title="Glean-Issued Tokens" href="./glean-issued" icon="key" color="#3b82f6">
...
<CardGroup cols={3}>
  ...
  <Card title="Chat Integration" href="/api/client-api/chat/overview" icon="message-circle">
