...
<CardGroup cols={2}>
<Card title="Search & Discovery" icon="magnifying-glass" color="#6366F1">
...
<CardGroup cols={1}>
  <Card title="Set Up Authentication" icon="key" href="../authentication/overview">
  ...
  <Card title="Explore Examples" icon="lightbulb" href="../examples/chatbot">
    Follow step-by-step tutorials for common integration patterns
  </Card>

  <Card title="Download API Clients" icon="box" href="../../../libraries/api-clients">
