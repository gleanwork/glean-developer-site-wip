...
<Card title="Index Your First Document" icon="file-import" href="index-documents">
  Follow our step-by-step guide to index content and make it searchable
</Card>

<Card title="Manage Authentication" icon="key" href="../authentication/overview">
