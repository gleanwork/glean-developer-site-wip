...
<CardGroup cols={3}>
  <Card title="Core Concepts" href="#core-concepts" icon="Zap">
  ...
  <Card title="Platform Features" href="#platform-features" icon="Settings">
...
<CardGroup cols={3}>
  ...
  <Card title="Support" href="https://support.glean.com" icon="LifeBuoy">
