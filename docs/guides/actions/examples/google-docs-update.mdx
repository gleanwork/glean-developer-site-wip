...
<Steps>
  <div>
    <h3>Step 1: Preparing the OpenAPI Specification</h3>
...
paths:
  ...
  <div>
    <h3>Step 2: Creating the Action</h3>
    ...
    <img src="./images/google-docs-update/basic_info.png" alt="Basic Info Dialog Box" />
    ...
    <img src="./images/google-docs-update/trigger_condition.png" alt="Trigger Condition Dialog Box" />
    ...
    <img src="./images/google-docs-update/functionality.png" alt="Functionality Dialog Box" />

    <p>Paste the OpenAPI specification you prepared in Step 1. Since we're using Google's API directly, leave the "Use existing on-premise server" option unchecked.</p>
  </div>

  <div>
    <h3>Step 3: Setting Up Authorization</h3>
