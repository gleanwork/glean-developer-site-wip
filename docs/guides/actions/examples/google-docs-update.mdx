...
<CardGroup cols={2}>
  ...
  <Card title="Schema Structure" icon="Network">
...
<CardGroup cols={2}>
  ...
  <Card title="Efficient Operations" icon="Activity">
...
<CardGroup cols={2}>
  <Card title="Document Operations" icon="FileEdit">
...
<Card title="Comprehensive Testing" icon="FlaskConical">
...
<Card title="Ongoing Operations" icon="TrendingUp">
