...
Actions can be created by anyone with an `Admin` or `App and Action Creator` role. Once the action is created, the creator can deploy the action to Glean Chat or Glean Apps.
...
<CardGroup cols={2}>
  <Card 
    ...
    icon="Shield"
    href="/guides/actions/authentication"
  >
    Learn how to configure authentication for your actions
  </Card>
  
  <Card 
    title="Create Actions"
    icon="Plus"
    href="/guides/actions/create-actions"
  >
    Step-by-step guide to creating your first action
  </Card>
  
  <Card 
    title="Examples"
    icon="Code"
    href="/guides/actions/examples/jira-issue-creation"
  >
    See working examples of actions in practice
  </Card>
  
  <Card 
    title="FAQ"
    icon="HelpCircle"
    href="/guides/actions/faq"
  >
