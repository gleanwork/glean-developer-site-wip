...
import { AgentIcon, ApiIcon, IntegrationIcon } from '@site/src/components/Icons';
...
|-----|---------|----------|
| **[Agents API](/api/client-api/agents/)** | Manage and execute pre-built agents | Use agents created in Agent Builder |
| **[Chat API](/api/client-api/chat/)** | Conversational AI with context | Build chat-based agents |
| **[Search API](/api/client-api/search/)** | Enterprise search capabilities | Retrieve relevant documents |
| **[Summarization API](/api/client-api/summarize/)** | AI-powered content summarization | Process and digest information |
...
# Execute query
response = agent_executor.invoke({"input": "Find our latest quarterly report"})
print(response["output"])
```

**Learn More:** [Complete LangChain Guide](/guides/langchain/)
...
<CardGroup cols={3}>
  <Card title="Cursor" icon={<IntegrationIcon />}>
    AI-powered code editor with MCP support
  </Card>
  <Card title="VS Code" icon={<IntegrationIcon />}>
    Popular editor with native MCP integration
  </Card>
  <Card title="Windsurf" icon={<IntegrationIcon />}>
    AI development environment
  </Card>
  <Card title="Claude Desktop" icon={<IntegrationIcon />}>
...
The Agent Builder provides a visual interface for creating agents directly in Glean. Agents created this way can still be accessed programmatically via the [Agents API](/api/client-api/agents/) for integration with your applications.
...
- **Need Help?** Check the [API Reference](/api/client-api/agents/) for technical details
