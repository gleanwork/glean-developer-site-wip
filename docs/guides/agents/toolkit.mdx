...
- **Examples**: Check out the [example notebooks](https://github.com/gleanwork/glean-agent-toolkit/tree/main/examples) 
- **Community**: Join the discussion in our [GitHub Discussions](https://github.com/gleanwork/glean-agent-toolkit/discussions) 