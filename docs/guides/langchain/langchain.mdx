---
title: LangChain
description: Build powerful AI agents using Python and the LangChain framework
---
...
# <Icon name="langchain" iconSet="glean" className="inline" height="2rem" /> Glean LangChain Integration
