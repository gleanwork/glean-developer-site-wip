...
import { Tip, Info } from '@site/src/components/Callouts';
...
<Tip>
  **Quick Start Recommendation:** If you're just getting started or want to test MCP integration, begin with the Local MCP Server. You can always migrate to the Remote MCP Server when it becomes generally available.
</Tip>
...
<Info>
  **Private Beta Status**: The Remote MCP Server is currently in private beta. It's available to select enterprise customers and requires special access from the Glean team.
</Info>
...
<CardGroup cols={2}>
  <Card 
    title="Start with Local MCP Server"
    icon="rocket"
    href="#local-mcp-server-available-now"
  >
    **Recommended for:** Developers, testing, immediate start
    
    Get up and running in minutes with the self-hosted solution.
  </Card>
  
  <Card 
    title="Request Remote MCP Beta"
    icon="star"
    href="mailto:support@glean.com?subject=Remote%20MCP%20Server%20Beta%20Access"
  >
    **Recommended for:** Enterprise deployments, production use
    
    Join the private beta for the hosted enterprise solution.
  </Card>
</CardGroup>
