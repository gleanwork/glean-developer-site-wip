...
:::info
**Authentication Required**: You'll need a [Client API token](/api-info/client/authentication/overview) to use these libraries.
:::

:::warning
**Client API Only**: These API clients are designed for the **Client API only**. For the Indexing API, you'll need to use HTTP requests directly with [Indexing API tokens](/api-info/indexing/authentication/overview).
:::
...
- **Authentication**: Support for user-scoped and global tokens
...
3. **Get your credentials** from the [Authentication Guide](/api-info/client/authentication/overview)
