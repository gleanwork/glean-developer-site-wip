...
//     protected async render(_token: string): Promise<void> {
...
//     private async attach(query: string): Promise<void> {
//         if (!this.element) return;
//         await window.GleanWebSDK.attach(this.element, { query });
//     }
...
// export default function GleanSearch(): ReactElement {
//   useEffect(() => {
//     // Load Glean SDK
//     const script = document.createElement('script');
//     script.src = 'https://glean-public-external.glean.com/embedded-search-latest.min.js';
//     script.defer = true;
//     script.onload = () => GleanSDKManager.initialize();
...
//     <input
//         type="text"
//         className="glean-search-box--hero"
//         id="glean-search-box"
//         aria-label="Search..."
...
function GleanSearchClient(): ReactElement {
  ...
  return (
    <input
      ...
      type="text"
      className="glean-search-box--hero"
      id={CONFIG.ELEMENTS.SEARCH_BOX}
      aria-label="Search..."
      placeholder="Search for answers with Glean..."
      style={{
        position: 'relative',
        display: 'block',
        minHeight: '50px',
...
export default function GleanSearch(): ReactElement {
  return (
    <div className={clsx('navbar__search', styles.searchBarContainer)}>
      <BrowserOnly
        fallback={
          <input
            type="text"
